...
CREATE TABLE `alarme` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK4hhjnl7u6bc9ft4m9wkesd9tc` (`id_usuario`),
  CONSTRAINT `FK4hhjnl7u6bc9ft4m9wkesd9tc` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`)
...
-- Dump completed on 2021-06-09  1:14:55
